...

{
    ...
    {
        try {
            AudioInputStream audioInputStream = AudioSystem.getAudioInputStream(new File("E:\\quiz\\Final Buzzer Program\\Final Buzzer Program\\red.wav").getAbsoluteFile());
            Clip clip = AudioSystem.getClip();
            clip.open(audioInputStream);
            clip.start();
        } catch(Exception ex) 
    ...
    {
        try {
            AudioInputStream audioInputStream = AudioSystem.getAudioInputStream(new File("E:\\quiz\\Final Buzzer Program\\Final Buzzer Program\\yellow.wav").getAbsoluteFile());
            Clip clip = AudioSystem.getClip();
            clip.open(audioInputStream);
            clip.start();
        } catch(Exception ex) 
    ...
    {
        try {
            AudioInputStream audioInputStream = AudioSystem.getAudioInputStream(new File("E:\\quiz\\Final Buzzer Program\\Final Buzzer Program\\green.wav").getAbsoluteFile());
            Clip clip = AudioSystem.getClip();
            clip.open(audioInputStream);
            clip.start();
        } catch(Exception ex) 
    ...
    {
        try {
            AudioInputStream audioInputStream = AudioSystem.getAudioInputStream(new File("E:\\quiz\\Final Buzzer Program\\Final Buzzer Program\\blue.wav").getAbsoluteFile());
            Clip clip = AudioSystem.getClip();
            clip.open(audioInputStream);
            clip.start();
        } catch(Exception ex) 
